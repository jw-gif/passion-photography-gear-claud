...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Passion Photography Hub" },
      { property: "og:description", content: "Request photography, request gear, and track everything the team is shooting." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Passion Photography Hub" },
      { name: "twitter:description", content: "Request photography, request gear, and track everything the team is shooting." },
